...
bikes_tbl      <- read_excel(path = "C:/Users/May/Documents/TUHH - Studium Hamburg/Master Schiffbau und Meerestechnik/BWL/Business Data Science Basics/ws20-business-data-science-basics---lab-journal-Laurie481/DS_101/00_data/01_bike_sales/01_raw_data/bikes.xlsx")
orderlines_tbl <- read_excel("C:/Users/May/Documents/TUHH - Studium Hamburg/Master Schiffbau und Meerestechnik/BWL/Business Data Science Basics/ws20-business-data-science-basics---lab-journal-Laurie481/DS_101/00_data/01_bike_sales/01_raw_data/orderlines.xlsx")

# Not necessary for this analysis, but for the sake of completeness
bikeshops_tbl  <- read_excel("C:/Users/May/Documents/TUHH - Studium Hamburg/Master Schiffbau und Meerestechnik/BWL/Business Data Science Basics/ws20-business-data-science-basics---lab-journal-Laurie481/DS_101/00_data/01_bike_sales/01_raw_data/bikeshops.xlsx")
...
bike_orderlines_wrangled_newly_tbl <- bike_orderlines_joined_tbl %>%
  ...
  select(order.id, contains("order"), contains("model"), contains("category"), contains("state"),
...
library(lubridate)
# Step 1 - Manipulate
sales_by_year_tbl <- bike_orderlines_wrangled_newly_tbl %>%
  
  # Select columns
  select(order_date, total_price, state) %>%
  
  # Add year column
 # mutate(state = state(order_date)) %>%
...
#  geom_smooth(method = "lm", se = FALSE) + # Adding a trendline
  ...
  labs(title    = "Revenue by state",
    subtitle = "NRW has the highest revenue",
    x = "", # Override defaults for x and y
    y = "Revenue")

# 6.2 Sales by Year and Category 2 ----
# now: sales by location and year
# Step 1 - Manipulate

sales_by_year_cat_1_tbl <- bike_orderlines_wrangled_newly_tbl %>%
...
library("writexl")
bike_orderlines_wrangled_newly_tbl %>%
  write_xlsx("C:/Users/May/Documents/TUHH - Studium Hamburg/Master Schiffbau und Meerestechnik/BWL/Business Data Science Basics/ws20-business-data-science-basics---lab-journal-Laurie481/DS_101/00_data/01_bike_sales/02_wrangled_data/bike_orderlines_newly.xlsx")

# 7.2 CSV ----

bike_orderlines_wrangled_newly_tbl %>% 
  write_csv("C:/Users/May/Documents/TUHH - Studium Hamburg/Master Schiffbau und Meerestechnik/BWL/Business Data Science Basics/ws20-business-data-science-basics---lab-journal-Laurie481/DS_101/00_data/01_bike_sales/02_wrangled_data/bike_orderlines_newly.csv")

# 7.3 RDS ----

bike_orderlines_wrangled_newly_tbl %>% 
  write_rds("C:/Users/May/Documents/TUHH - Studium Hamburg/Master Schiffbau und Meerestechnik/BWL/Business Data Science Basics/ws20-business-data-science-basics---lab-journal-Laurie481/DS_101/00_data/01_bike_sales/02_wrangled_data/bike_orderlines_newly.rds")
